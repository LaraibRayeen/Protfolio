      ...
      <nav className="navbar navbar-expand-lg fixed-top mb-5  bg-light">
        <div className="container p-0 m-0">
          <a className="navbar-brand" href="#Home">
            <img
              src={logo}
              className="img-fluid w-75 h-auto d-inline-block"
              alt="laraib"
            ></img>
          </a>
          <button
          ...
          <div
            className="collapse navbar-collapse justify-content-end text-sm-center"
            id="navbarNav"
          >
            <ul className="navbar-nav">
              <li className="nav-item my-0  mx-2  position-relative ">
                <a
                  className="nav-link active link-dark fs-5 mylink  h3  "
                  aria-current="page"
                  href="#Home"
                >
                  Home
              ...
              <li className="nav-item my-0  mx-2 position-relative">
                <a
                  className="nav-link  link-dark fs-5  mylink h3"
                  href="#About"
                >
                  About
                </a>
